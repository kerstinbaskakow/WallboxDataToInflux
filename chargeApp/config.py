...
class Config:
    ...
    ACTIVE_PHASES_DET_INFLUX_QUERY = 'SELECT * FROM {} ORDER BY time DESC'.format(ACTIVE_PHASES_DET_INFLUX)
    CHARGE_STATE_INFLUX = "ChargingState" 
    CHARGE_STATE_INFLUX_QUERY = 'SELECT * FROM {} ORDER BY time DESC'.format(CHARGE_STATE_INFLUX)
    CHARGE_POWER_INFLUX = "ChargePower_W" 
    CHARGE_POWER_INFLUX_QUERY = 'SELECT * FROM {} ORDER BY time DESC'.format(CHARGE_POWER_INFLUX)
    ...
    BATTERY_POWER_INFLUX_QUERY = 'SELECT * FROM "{}" ORDER BY time DESC'.format(BATTERY_POWER_INFLUX)
    HOME_POWER_INFLUX = "modbus.0.holdingRegisters.40071_Hausverbrauch_Leistung"
    HOME_POWER_INFLUX_QUERY = 'SELECT * FROM "{}" ORDER BY time DESC'.format(HOME_POWER_INFLUX)